...
**Statut équipe** : solo (Jean-Sébastien Lefevre / @Elladriel80). Le projet rouvre à investisseurs externes et contributeurs open-source via le repo `augure-rounds`.
